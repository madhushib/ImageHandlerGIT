 ...
 */
ImageHandler.ImageGrid = function(imageContainerId, gridWidth, thumbnailType, isShowImageSize, isShowImageName) {
...
ImageHandler.ImageGrid.prototype = {
         ...
         if (imgInfo) {
            ...
            cellBox.addEventListener("click", function(event){
                if (event.button == 0) { //Left mouse button click
                    ImageHandler.Controller.handleClickOnImage(imgInfo.id);
                }
            }, false);
